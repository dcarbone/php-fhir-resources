 ...
 */
class FHIRSeries extends AbstractFHIRObject
{
    /** @var FHIRInteger */
    ...
    /** @var FHIRInstance[]|ResourceComponentCollection */
    protected $instance;
    ...
    /**
     * @return ResourceComponentCollection|FHIRInstance[]
     */
    ...
    /**
     * @param FHIRInstance $instance
     */
    public function addInstance(FHIRInstance $instance)
    {
