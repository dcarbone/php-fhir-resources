 ...
 */
class FHIRRecommendation extends AbstractFHIRObject
{
    /** @var FHIRDateTime */
    protected $date = null;
    ...
    /** @var FHIRProtocol[]|ResourceComponentCollection */
    protected $protocol;

    /** @var FHIRDateCriterion[]|ResourceComponentCollection */
    ...
    /**
     * @return ResourceComponentCollection|FHIRProtocol[]
     */
    ...
    /**
     * @param FHIRProtocol $protocol
     */
    public function addProtocol(FHIRProtocol $protocol)
    {
        $this->protocol->append($protocol);
    }

    /**
     * @return ResourceComponentCollection|FHIRDateCriterion[]
     */
    ...
    /**
     * @param FHIRDateCriterion $dateCriterion
     */
    public function addDateCriterion(FHIRDateCriterion $dateCriterion)
    {
