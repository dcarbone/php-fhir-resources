 ...
 */
class FHIRRelation extends AbstractFHIRObject
{
    /** @var FHIRString */
    protected $name = null;
    ...
    /** @var FHIRCondition[]|ResourceComponentCollection */
    ...
    /**
     * @return FHIRCondition[]|ResourceComponentCollection
     */
    ...
    /**
     * @param FHIRCondition $condition
     */
    public function addCondition(FHIRCondition $condition)
    {
